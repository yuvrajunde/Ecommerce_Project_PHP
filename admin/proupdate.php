        ...
        <div class="col-sm-6">
          ...
          ?>
            ...
            <div class="form-group">
              ...
              <input type="file" id="picture" name="file" value="<?php echo $final['pictures']?>">
            </div>

            <div class="form-group">
              <label for="Description">Description</label>
              <textarea type="description" class="form-control" rows="10" placeholder="Enter Description" name="description" value="<?php echo $final['description']?>"></textarea>
            </div>
